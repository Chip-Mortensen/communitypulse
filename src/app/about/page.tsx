  ...
  return (
    <PageContainer>
      <div className="max-w-6xl mx-auto p-6">
        <h1 className="text-2xl font-bold mb-6">About CommunityPulse</h1>
        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden mb-8 border border-gray-200">
          <div className="p-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <h3 className="font-medium text-lg mb-3">Report Issues</h3>
              ...
              <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <h3 className="font-medium text-lg mb-3">Upvote & Comment</h3>
                <p className="text-gray-600">
              ...
              <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <h3 className="font-medium text-lg mb-3">Collaborate</h3>
                <p className="text-gray-600">
